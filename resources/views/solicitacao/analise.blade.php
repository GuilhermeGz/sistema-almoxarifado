...
@section('content')
    ...
    <form method="POST" id="formSolicitacao" name="formSolicitacao" >
        @csrf
                        ...
                        <div id="modalBody" style="display: none">
                            <table id="tableItens" class="table table-hover table-responsive-md" style="margin-top: 10px">
                                ...
                                <tr>
                                    ...
                                    <th class="align-middle" scope="col" style="text-align: center; width: 10%">Alterar Material</th>
                                </tr>
                                </thead>
    ...
    <div id="trocaMaterial">
        <div class="modal fade" id="infoTroca" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" style="color:#151631">Trocar Material</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                    <form id="form_troca">
                        ...
                        <div class="modal-body">
                            <div class="row" id="trocaConteudo">
    ...
    $(document).ready(function () {
        ...
        $('#form_troca').submit(function (e) {
            ...
            $.ajax({
                ...
                data: {
                    'itemAtual': itemAtual,
                    'itemSelicionado': itemSelicionado,
                    'solicitacao_id': solicitacao_id,
                    'quant_material': quant_material
                },
